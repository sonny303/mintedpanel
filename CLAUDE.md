...
targets `staging`, then promote `staging` → `main` (see
[`docs/ops/repo-workflow.md`](docs/ops/repo-workflow.md)); never self-merge.
Do not target the retired `redesign` branch.
