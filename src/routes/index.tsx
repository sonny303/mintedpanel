...
function LiveStatusCard() {
  ...
  return (
    ...
    >
      ...
      <div style={{ fontSize: 17, fontWeight: 600, color: '#14301f', marginBottom: 3 }}>Dr. Sonny Ali</div>
      <div style={{ fontSize: 13, color: '#6B7370', marginBottom: 18 }}>Aetna · Texas · Case #4821</div>
      <div style={{ height: 6, borderRadius: 3, background: '#ECE9DF', overflow: 'hidden', marginBottom: 14 }}>
        <div
          style={{
            height: '100%',
            width: s.w,
        ...
        {items.map((it) => {
          ...
          return (
            <div key={it.label} ref={r.ref} style={{ ...r.style, display: 'flex', flexDirection: 'column', gap: 6 }}>
              <div style={{ fontSize: 48, fontWeight: 600, letterSpacing: '-0.02em', color: '#1B4A38' }}>
...
function SectionEyebrow({ children }: { children: React.ReactNode }) {
  return (
    <div style={{ fontSize: 13, fontWeight: 700, letterSpacing: '0.14em', color: '#1D5540', marginBottom: 16 }}>
      {children}
    </div>
  );
}
...
function WhoWeWorkWith() {
  ...
  return (
    <div style={{ maxWidth: 1120, margin: '0 auto', padding: '100px 32px' }}>
      ...
      >
        Whether you're opening a new location or managing multiple credentialing cases at once, Minted Panel gives you the infrastructure to scale without the bottlenecks.
      </p>
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: 24 }}>
        <div ref={c1.ref} style={c1.style}>
          <HoverLiftCard>
            <div style={{ fontSize: 21, fontWeight: 600, marginBottom: 12 }}>Practice Owners &amp; Operators</div>
            <p style={{ fontSize: 15, color: '#55605a', lineHeight: 1.6, margin: '0 0 20px' }}>
              You're expanding, hiring providers, and entering new states at the same time. Credentialing delays can cost weeks of lost revenue before a provider ever sees a patient.
            </p>
            <BulletList
              items={[
        ...
        <div ref={c2.ref} style={c2.style}>
          <HoverLiftCard>
            <div style={{ fontSize: 21, fontWeight: 600, marginBottom: 12 }}>Credentialing Managers</div>
            <p style={{ fontSize: 15, color: '#55605a', lineHeight: 1.6, margin: '0 0 20px' }}>
              You're tracking dozens of active cases across payers and states. We replace manual follow-up with a real-time dashboard and a team that handles every touch.
            </p>
            <BulletList
              items={[
...
function Problem() {
  ...
  return (
    <div style={{ background: '#F3F1E9', borderTop: '1px solid #E7E4DA', borderBottom: '1px solid #E7E4DA' }}>
      <div
        style={{
          maxWidth: 1120,
          margin: '0 auto',
      ...
      >
        <div>
          ...
          >
            Every week a provider sits uncredentialed is a week of revenue you can't collect. For a mid-volume medical practice, even one delayed case can mean thousands in lost or delayed revenue. Multiply that across a growing roster, and the cost adds up fast.
          </p>
        </div>
        <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
          <div ref={oldCard.ref} style={oldCard.style}>
            <div style={{ background: '#FFFFFF', border: '1px solid #E7E4DA', borderRadius: 16, padding: 28 }}>
              <div style={{ fontSize: 15, fontWeight: 700, color: '#96552B', marginBottom: 14 }}>The old way</div>
              <div style={{ display: 'flex', flexDirection: 'column', gap: 9, fontSize: 15, color: '#55605a' }}>
                {[
          ...
          <div ref={mpCard.ref} style={mpCard.style}>
            <div style={{ background: '#1B4A38', borderRadius: 16, padding: 28, position: 'relative', overflow: 'hidden' }}>
              <div style={{ position: 'absolute', inset: 0, ...DOT_TEXTURE }} />
              <div style={{ position: 'relative' }}>
                <div style={{ fontSize: 15, fontWeight: 700, color: '#FCFBF7', marginBottom: 14 }}>The Minted Panel way</div>
                <div style={{ display: 'flex', flexDirection: 'column', gap: 9, fontSize: 15, color: 'rgba(240,239,230,0.85)' }}>
                  {[
...
function HowItWorks() {
  ...
  return (
    <div style={{ maxWidth: 1120, margin: '0 auto', padding: '100px 32px', position: 'relative' }}>
      ...
      >
        Our process keeps your team focused. You share what we need &amp; we handle the rest, from submission to active network status.
      </p>
...
function WhatWeHandle() {
  ...
  const p = useReveal(160);
  const items = [
    ['Provider Enrollment', 'Initial applications submitted to target payers — commercial, Medicare, and Medicaid — with full document management.'],
    ['Payer Contracting', 'We manage payer contracts so your providers stay in-network and billing at the right rates.'],
    ['CAQH Management', 'Ongoing attestation and updates so providers stay active and never miss a re-attestation.'],
    ['Multi-State Licensing', 'Coordinated state license management as you expand into new markets.'],
    ['Deadline Tracking', 'Every deadline, re-credentialing cycle, and expiration date is tracked proactively.'],
    ['Real-Time Dashboard', "A live view of every provider's status across every payer for your whole team."],
  ];
  return (
    <div style={{ background: '#F3F1E9', borderTop: '1px solid #E7E4DA', borderBottom: '1px solid #E7E4DA' }}>
      <div style={{ maxWidth: 1120, margin: '0 auto', padding: '100px 32px' }}>
        ...
        <p
          ref={p.ref}
          style={{ ...p.style, fontSize: 17, color: '#6B7370', lineHeight: 1.6, margin: '0 0 48px', maxWidth: 620 }}
        >
          Minted Panel covers the full lifecycle from enrollment to ongoing maintenance, so nothing falls through the cracks.
        </p>
  ...
  return (
    ...
    >
      <div>
        ...
        <p ref={p1.ref} style={{ ...p1.style, fontSize: 16, color: '#55605a', lineHeight: 1.65, margin: '0 0 16px' }}>
          Minted Panel is built for healthcare provider organizations in motion. Whether you're credentialing one provider or managing a 200-provider roster across 12 locations, our infrastructure and team scale with you.
        </p>
        <p ref={p2.ref} style={{ ...p2.style, fontSize: 16, color: '#55605a', lineHeight: 1.65, margin: 0 }}>
          We support single-site practices ready to expand and regional or national provider networks that have outgrown in-house credentialing. Our process is consistent, documented, and built for volume.
        </p>
      </div>
...
function WhyMintedPanel() {
  ...
  const features = [
    ['Dedicated to healthcare providers', 'We work exclusively with healthcare provider groups, so we understand your payers, state requirements, and the credentialing issues that slow provider organizations down.'],
    ['Proactive, not reactive', 'We monitor open applications, follow up on missing information, and escalate stalled cases to keep files moving.'],
    ['Full transparency, always', "Every action is logged. You can see each case's status, what's been submitted, and what still needs attention."],
    ['Your team stays lean', 'You get enterprise-grade credentialing infrastructure without hiring an in-house specialist for every 50 providers.'],
  ];
  const minis = [
    ['No more status chasing', 'Your team stops asking where providers stand. The dashboard shows it first.', 0],
    ['Revenue protection', 'Faster credentialing means faster billing. Every week saved is a week of collections retained.', 100],
    ['Peace of mind at scale', 'As you add providers and states, your credentialing process scales with you automatically.', 200],
  ] as const;
  return (
    <div style={{ background: '#F3F1E9', borderTop: '1px solid #E7E4DA', borderBottom: '1px solid #E7E4DA' }}>
      <div style={{ maxWidth: 1120, margin: '0 auto', padding: '100px 32px' }}>
        ...
        >
          ...
          <img
            src={LOGO}
            alt=""
            style={{ position: 'absolute', width: 300, right: -70, top: -60, opacity: 0.1, filter: 'brightness(4)' }}
          />
          <div style={{ position: 'relative', maxWidth: 720 }}>
            ...
            >
              "We were opening two new locations at the same time and had five providers waiting to credential. Minted Panel took it off our plate, and we didn't lose a week of billing on either opening."
            </div>
            <div style={{ fontSize: 15, color: 'rgba(240,239,230,0.7)' }}>
              — Practice Owner, Multi-Site Healthcare Group · <span style={{ fontStyle: 'italic' }}>Illustrative example</span>
            </div>
          </div>
        </div>
        <div
...
function FinalCTA() {
  ...
  return (
    <div id="cta" style={{ maxWidth: 1120, margin: '0 auto', padding: '110px 32px', position: 'relative' }}>
      <img
        src={LOGO}
        alt=""
        style={{
      ...
      <div style={{ textAlign: 'center', maxWidth: 640, margin: '0 auto' }}>
        ...
        <p
          ref={p.ref}
          style={{ ...p.style, fontSize: 17, color: '#6B7370', lineHeight: 1.6, margin: '0 0 36px' }}
        >
          Schedule a brief call to review your provider roster and target payers. See how Minted Panel gets your providers in-network faster. Existing clients can log in to access their dashboard.
        </p>
        <div ref={c.ref} style={{ ...c.style, display: 'flex', gap: 14, justifyContent: 'center', flexWrap: 'wrap' }}>
          <a
            href="#cta"
            style={{
              display: 'inline-flex',
