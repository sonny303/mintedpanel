...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "OpenPanel" },
      { name: "description", content: "Credentialing operations for allied health organizations." },
      { name: "author", content: "OpenPanel" },
      { property: "og:title", content: "OpenPanel" },
      { property: "og:description", content: "Credentialing operations for allied health organizations." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "OpenPanel" },
