...
export function compareForSort(
  ...
  return (
    String(a).localeCompare(String(b), undefined, { sensitivity: "base", numeric: true }) * mult
  );
}
...
export function InfiniteScrollSentinel({
  ...
  return (
    <div
      ref={sentinelRef}
      className="h-10 flex items-center justify-center text-[12px] text-muted-foreground"
    >
      {loadingMore ? (
