...
const ITEMS = [
  ...
  { icon: AlarmClock, title: 'Deadline Tracking', copy: 'Every deadline, re-credentialing cycle, and expiration date is tracked proactively.' },
  { icon: BarChart3, title: 'Real-Time Dashboard', copy: "A live view of every provider's status across every payer for your whole team." },
];
  ...
  return (
    <section className="max-w-6xl mx-auto px-6 py-20">
      ...
      <div className="mt-10 grid gap-6 md:grid-cols-2">
        {ITEMS.map((it) => (
          <div key={it.title} className="border border-[#E8E5E0] rounded-md bg-white p-6 flex gap-4">
