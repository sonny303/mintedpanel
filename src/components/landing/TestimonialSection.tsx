...
const CARDS = [
  {
    title: "No more status chasing",
    copy: "Your team stops asking where providers stand. The dashboard shows it first.",
  },
  {
    title: "Revenue protection",
    copy: "Faster credentialing means faster billing. Every week saved is a week of collections retained.",
  },
  {
    title: "Peace of mind at scale",
    copy: "As you add providers and states, your credentialing process scales with you automatically.",
  },
];
    ...
    <section className="max-w-6xl mx-auto px-6 py-20">
      ...
      <div className="mt-12 grid gap-6 md:grid-cols-3">
        {CARDS.map((c) => (
          <div
            key={c.title}
            className="border-l-2 border-[#1B4D3E] border-t border-r border-b border-t-[#E8E5E0] border-r-[#E8E5E0] border-b-[#E8E5E0] rounded-r-md bg-white p-6"
          >
