...
| **Keep `org_payer_assignments` table** | **R1 B locked 2026-08-10**            | Retire as a **gate** only (catalog visibility / attach / `create_payer` side-effect). Table + rows stay **dormant** (additive — never DROP). Not a generation candidacy input. Work id: **OPA-RETIRE** (not “Slice 3” — #280). |
