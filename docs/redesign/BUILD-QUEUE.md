...
| 3   | E6.2 Groups & Payer Network board  | `E6.2-groups-payer-network.md`        | E6.0, E6.1                                        | in review | #203 |
| 4   | E6.3 Decoupled generation          | `E6.3-decoupled-generation.md`        | E6.0, E6.2                                        | in review | #205 |
