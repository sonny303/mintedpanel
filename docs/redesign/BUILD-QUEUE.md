...
| 6   | E6.5 Payer Setup consolidation     | `E6.5-payer-setup-consolidation.md`   | — (sidebar entry coordinated with E6.1 at review) | merged    | #210 |
| 7   | E6.6 Reporting & touch unification | `E6.6-reporting-touch-unification.md` | E6.0, E6.2, E6.5                                  | in review | #214 |
