...
| **R5 — Scale pack**         | E3.0 import intake, E3.1 preview/staged commit, E3.3 sectioned intake uniformity                                                                                                                                                                                                 | 🚧 Discovery complete ([r5], 12 decisions); E3.0–E3.2 drafted, independently reviewed & `reviewed: true` (§5 enablers, merged via #149); E3.0 review PM questions resolved ([r5-review]) and author edits applied. E3.0 built & merged (#152). [r5-debt] intake-uniformity gap recorded — E3.3 Sectioned Intake Uniformity added (per-section CSV uploads beside every manual form, combined roster retired; to draft + PM review). Build queue: E3.1 → E3.3. E3.2 NPPES aid moved to end of redesign (PM 2026-07-13: nice-to-have, not a requirement). CAQH deferred to a later release. |
