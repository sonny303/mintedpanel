...
```
R0 ✅ ──► R1 ✅ ──► R2 ✅ ──► R3 ✅ ──► R4 🚧 discovery done, epics drafting ──► R5…R10 📋
```
...
1. **R4 epic drafting** — E1.7b + E2.x, grounded in the locked [r4] decisions and the SOP worked examples; then the R1-style review queue.
