...
**2026-07-13** (R4 builds 4/6 — E1.7b/E2.0/E2.1/E2.2 built & merged; E2.3 build next)._

```
R0 ✅ ──► R1 ✅ ──► R2 ✅ ──► R3 ✅ ──► R4 🚧 builds 4/6 (E1.7b/E2.0/E2.1/E2.2 ✅, E2.3 next) ──► R5…R10 📋
```
...
| **R4 — Case generation**    | E1.7b SOP-as-data, E2.x preview/generate/dedupe/traceability/audit          | 🚧 All six epics independently reviewed (#134–#139) with PM answers applied ([r4-review], #140) — all `reviewed: true`. **Built & merged: E1.7b (#141), E2.0 (#143), E2.1 (#144), E2.2 (#145).** Sequential builds continue: E2.3 (next) → E2.4.                |
...
| E2.4  | Generation traceability & audit     | ✅       | ⏳ queued (after E2.3) |
