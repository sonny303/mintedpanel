...
| TS-55       | Deadline-ordered queue (E2.3)            | Open cases with mixed deadline signals (near provider start date vs later task due date) plus a fresh generation batch (L3 + L1)                                               | The queue ranks the start-date-driven action first with a stated reason; the post-generation landing filters to the batch                                                                     |
