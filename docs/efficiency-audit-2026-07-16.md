...
| Full e2e (40 spec files, ~107 tests) | **≈ 10min+** | see §3-F2; rarely run in full |
...
docs-only ones (they'd pass instantly). The real costs are (a) the e2e
dev-server boot tax, and (b) everything that isn't compute: review loops,
ceremony PRs, rework, and per-session context re-derivation.
...
#159/#160/#163-class of small fixes. Governance-authorization *commits*
...
rebuild; #160 recovered a dead-ended flow; #167 is a full parity *audit* PR
...
- [ ] Schedule the CLAUDE.md diet as the *last* lane of a session that's
